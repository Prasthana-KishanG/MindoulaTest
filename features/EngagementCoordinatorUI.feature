@VerifyEngagementCoordinatorUI
Feature:Verify Engagement CoordinatorUI
...
@VerifyiconsInEngagementCoordinator
Scenario: Verify Icons Exists in Engagement Coordinator
...
|MMR_CASEMANAGER|MMR Engagement|
