@VerifyProgramManagerUI
Feature:VerifyProgramManagerUI
...
@VerifyAnalyticsExistsIntheLeftNavigation
Scenario:Verify Analytics Exists in Left Navigation

Then Veify Analytics Button Analytics Text Exists in Left Navigation
|ICON|analytics|
|ICON_EXISTS|YES|

Then Click on the Analytics 
Then Verify the Analytics page Opened.
|HEADER_NAME|
| Analytics |
Then Verify the Analytics Text in the Header
|HEADER_NAME|
| Analytics |


@VerifyProgramsExistsIntheLeftNavigation
Scenario:Verify Programs Exists in Left Navigation

Then Veify Programs Button Programs Text Exists in Left Navigation
|ICON|programs|
|ICON_EXISTS|YES|

Then Click on the Programs 
Then Verify the Programs page Opened.
|HEADER_NAME|
| Programs |
Then Verify the Programs Text in the Header
|HEADER_NAME|
| Programs |

@VerifyiconsInProgrammanager
Scenario: Verify Icons Exists in program manager
...
Then Verify the Text in the Program manager Pop Up
|PROGRAM_MANAGER|MMR ProgramManager|
